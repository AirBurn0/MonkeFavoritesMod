...
class ItemSlotPatch
{
    [HarmonyPatch(nameof(ItemSlot.Initialize), [typeof(BasePickupItem), typeof(ItemStorage), typeof(ItemSlot.DisplayMode)]), HarmonyPrefix]
    ...
    [HarmonyPatch(nameof(ItemSlot.InitializeEmpty), [typeof(ItemStorage)]), HarmonyPrefix]
